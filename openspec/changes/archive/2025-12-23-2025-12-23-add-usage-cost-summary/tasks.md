...
- [x] 1.4 Update `dashboard/src/content/copy.csv` for any new labels.
- [x] 1.5 Update `BACKEND_API.md` summary response schema.
- [x] 1.6 Add edge-function test coverage for summary cost calculation.
- [x] 1.7 Rebuild InsForge functions (`npm run build:insforge`).
