...
- `node scripts/validate-copy-registry.cjs` => warnings only (unused keys: landing.meta._, share.meta._, identity_card.operator_label, identity_panel.access_label, usage.summary.since, dashboard.session.label)
