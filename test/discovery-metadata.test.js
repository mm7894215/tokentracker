...
const README_EXPECTATIONS = [
  ["README.md", /30 AI coding tools/, /\|\s+\*\*AI tools supported\*\*\s+\|\s+\*\*30\*\*/, /Rate-limit tracking.*✅ 13 providers/],
  ["README.zh-CN.md", /30 款 AI 编码工具/, /\|\s+\*\*支持的 AI 工具数\*\*\s+\|\s+\*\*30\*\*/, /限额追踪.*✅ 13 家 provider/],
  ["README.ja.md", /30 種類の AI コーディングツール/, /\|\s+\*\*対応 AI ツール数\*\*\s+\|\s+\*\*30\*\*/, /レート制限トラッキング.*✅ 13 プロバイダー/],
  ["README.ko.md", /30개의 AI 코딩 도구/, /\|\s+\*\*지원 AI 도구\*\*\s+\|\s+\*\*30\*\*/, /레이트 제한 추적.*✅ 13개 프로바이더/],
  ["README.de.md", /30 KI-Coding-Tools/, /\|\s+\*\*Unterstützte KI-Tools\*\*\s+\|\s+\*\*30\*\*/, /Rate-Limit-Tracking.*✅ 13 Provider/],
];
...
test("marketing logo wall includes the same 30 product integrations", () => {
  ...
  for (const provider of ["every-code", "reasonix", "kilocode", "roocode", "zed", "goose", "droid", "qoder", "anythingllm"]) {
