...
自动采集 **35 款 AI 编码工具** 的 token 用量，全程本地聚合，用一套漂亮的 Dashboard 看真实成本与趋势。不需要云账号、不需要 API Key、不需要任何配置 —— 一条命令搞定。
...
|--------------------------|:---:|:---:|:---:|
| **支持的 AI 工具数**     | **35**           | 1（Claude）  | 1（Cursor）   |
| **本地优先，无需账号**   | ✅               | ✅           | ❌            |
