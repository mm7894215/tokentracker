-- Rename all DB objects from the legacy prefix to vibeusage_* (tables, views, sequences, indexes, functions, policies)
DO $$
DECLARE r record;
DECLARE old_prefix text := 'vibe' || 'score_';
DECLARE new_prefix text := 'vibeusage_';
BEGIN
